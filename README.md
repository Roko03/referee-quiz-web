...
```
$ git clone https://github.com/Roko03/nextjs-boilerplate.git <my-project-name>
$ cd <my-project-name>
$ yarn
```
...
This project use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/Roko03/nextjs-boilerplate/tags).
